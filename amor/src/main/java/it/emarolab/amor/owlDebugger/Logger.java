...
public class Logger {
	...
	public static class LoggerFlag{
		 ...
		 * Actual value: {@value #LOG_REFERENCES_CONTAINER}.
		 */
		...
		/**
		 * @return the {@link #LOG_REFERENCES_INTERFACE}
		 */
		...
		/**
		 * @param logReferencesInterface the {@link #LOG_REFERENCES_INTERFACE} to set
		 */
